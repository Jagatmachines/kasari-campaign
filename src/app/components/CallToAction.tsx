    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-[#003DA5] via-[#002970] to-[#001a50] text-white relative overflow-hidden">
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          {/* Social Share */}
          <div className="pt-8">
            <p className="text-blue-200 mb-4">Follow us for voter questions, tools, and updates.</p>
            <div className="flex justify-center gap-4">
              <a
                href="https://www.facebook.com/kasari.promisetopolicy"
                target="_blank"
              ...
              >
               ...
               <a
                href="https://www.instagram.com/kasari.promisetopolicy/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-white/10 hover:bg-white/20 transition-colors"
              >
